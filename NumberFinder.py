...
def find_number(gram):
    ...
    numeric_number = ['০', '১', '২', '৩', '৪', '৫', '৬', '৭', '৮', '৯', '১০', '১১', '১২', '১৩', '১৪', '১৫', '১৬',
                      '১৭', '১৮', '১৯', '২০', '২১', '২২', '২৩', '২৪', '২৫', '২৬', '২৭', '২৮', '২৯', '৩০', '৩১', '৩২',
                      '৩৩', '৩৪', '৩৫', '৩৬', '৩৮', '৩৯', '৪০', '৪১', '৪২', '৪৩', '৪৪', '৪৫', '৪৬', '৪৭', '৪৮', '৪৯']
    ...
    taglist1 = ['সভাপতি', 'গৃহবধূ', 'শিশু', 'কৃষক', 'স্ত্রী', 'যুবক', 'ছাত্র', 'ছাত্রী']
    taglist2 = ['দম্পতি', 'মা-মেয়ে', 'ভাই-বোন', 'মামা-ভাগ্নে', 'স্বামি-স্ত্রী']
